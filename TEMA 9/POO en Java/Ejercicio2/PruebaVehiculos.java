...
public class PruebaVehiculos{
  public static void main(String[] args) {
    int option = 0;
    int km;
    Bicicleta A1 = new Bicicleta(5);  //Crea una bicicleta con 5 piñones
    Coche JMY = new Coche(940); //Crea un coche con 940cm de motor.
    while (option !=8){
      ...
      switch (option) {
        ...
        System.out.println(A1.getKilometrosRecorridos() + " Km");
        break;
        case 6:
        System.out.println("El coche lleva recorridos ");
        System.out.println(JMY.getKilometrosRecorridos() + " Km");
        break;
        case 7:
