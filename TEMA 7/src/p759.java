...
public class p759 {
  public static void main(String[] args) throws InterruptedException {
    ...
    //---------> SETTING UP
    int EndingPoint = Size-1;   //--> JUST FOR BEGGINING
    
    int StartertPoint1 = 1;
    int EndingPoint1 = Size-1;
    
    int StartertPoint2 = 1;
    int EndingPoint2 = Size-1;
    
    int StartertPoint3 = Size-2;
    int EndingPoint3 = 0;
    
    int StartertPoint4 = Size-2;
    int EndingPoint4 = 0;
    ...
    int Constant1 = 0;
    int Constant2 = Size-1;
    int Constant3 = Size-1;
    int Constant4 = 0;
